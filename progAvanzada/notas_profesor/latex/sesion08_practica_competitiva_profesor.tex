% =============================================================================
%  Notas del profesor — Sesión 08: Práctica competitiva con bits
%  Programación Avanzada — Universidad Panamericana
%  Compilar: pdflatex sesion08_practica_competitiva_profesor.tex
% =============================================================================
...
% =============================================================================
\section{Problema 1: Los bits de la clase de programación (Algoritmo de Phil)}
% =============================================================================
...
\begin{tabular}{lp{8cm}}
  ...
  Algoritmo de Phil
    & Simulación: extraer bit(s) central(es), mayor primero en caso par.
      Acumular $S$ como entero con módulo. \\[4pt]
  Chasquidos Mágicos
  ...
  Separación enum.\ 1s
    & Enumerar 1s con bucle (algoritmo del enunciado).
      Alternativa: $a = n$ \texttt{\&} \texttt{0x55}; $b = n$ \texttt{\&} \texttt{0xAA}. \\
  \bottomrule
\end{tabular}
\end{center}
