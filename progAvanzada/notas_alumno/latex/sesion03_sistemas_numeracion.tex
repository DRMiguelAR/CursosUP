...
\subsection{Octal ↔ Binario: la relación directa}
...
\begin{tabular}{lcl}
  ...
  Binario ↔ octal           & Grupos de 3 bits            & Directo, sin pasar por decimal \\
  Binario ↔ hexadecimal     & Grupos de 4 bits            & Directo, sin pasar por decimal \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}
  ...
  \item \textbf{Binario ↔ octal:} grupos de 3 bits. \quad
        \textbf{Binario ↔ hex:} grupos de 4 bits.
