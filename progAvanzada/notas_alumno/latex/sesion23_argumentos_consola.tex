...
\subsection{Un primer programa con \texttt{argc}/\texttt{argv}}

\textbf{hola\_args.cpp}:
\begin{verbatim}
#include <iostream>
using namespace std;
...
\textbf{suma.cpp} — suma todos los argumentos como enteros:
\begin{verbatim}
#include <iostream>
#include <cstdlib>
using namespace std;
