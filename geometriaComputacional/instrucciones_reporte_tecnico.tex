...
El reporte técnico constituye el examen alternativo para los equipos cuyo sistema
procese y visualice correctamente los archivos \textit{layer} de todos los demás
equipos.  Documenta formalmente el sistema implementado y demuestra el cumplimiento
de los siguientes resultados de aprendizaje de la materia, los cuales deberán
abordarse explícitamente en la introducción y en las conclusiones:
...
\begin{enumerate}
  ...
  \item \textbf{Conclusiones.} Reflexión sobre las decisiones de diseño, las
        ...
        trabajo futuro.
  \item \textbf{Bibliografía.} Mínimo cinco fuentes académicas en formato IEEE
        o APA, aplicado de manera consistente.  Las fuentes deberán estar citadas
        en el texto; toda afirmación técnica requiere su referencia.
\end{enumerate}
...
\begin{itemize}
  \item Subdivisiones planares y DCEL: componentes (vértices, semi-aristas,
        caras), punteros y operaciones soportadas.
...
\begin{enumerate}
  ...
  \item Capas superpuestas o estado del algoritmo de barrido.
  \item Capa resultante de la fusión con caras identificadas.
  \item Cara externa seleccionada en la interfaz.
  \item Selección y deselección de caras internas.
  \item Procesamiento de un ejemplo de otro equipo (identificar el equipo
        de origen).
\end{enumerate}
